...
tLoRaSettings LoRaSettings =
{
    ...
    20,				// 发射功率 Power		
    9,	//500k		// 信号带宽	SignalBw [0: 7.8kHz, 1: 10.4 kHz, 2: 15.6 kHz, 3: 20.8 kHz, 4: 31.2 kHz,
					// 			5: 41.6 kHz, 6: 62.5 kHz, 7: 125 kHz, 8: 250 kHz, 9: 500 kHz, other: Reserved]
    8,	//256		// 扩频因数 [6: 64, 7: 128, 8: 256, 9: 512, 10: 1024, 11: 2048, 12: 4096  chips]
...
void SX1276LoRaInit( void )
{
    ...
    SX1276LoRaSetLowDatarateOptimize( true );						//开启低数据率优化
	...
	//设置斜升/斜降时间
//	SX1276LR->RegPaRamp = 0x0f;										//时间设置为：1111	--	10us
//	SX1276Write(REG_LR_PARAMP, SX1276LR->RegPaRamp);				//往寄存器写入设定值(0x0f)

//	SX1276LR->RegPaRamp = 0x09;										//设为缺省值
//	SX1276Read(REG_LR_PARAMP,&SX1276LR->RegPaRamp);					//读取寄存器的值
